...
def app_sst(model_path: str, lm_path: str, lm_alpha: float, lm_beta: float, beam: int):
    ...
    while True:
        if webrtc_ctx.audio_receiver:
            ...
            if len(sound_chunk) > 0:
                ...
                logger.warning("########### BUFFER: {0} ###########".format(buffer))
        else:
    ...
    # audio_buffer.export(os.path.join('voice_record', 'record.wav'), format='wav')
...
def app_sst_with_video(
    ...
    audio_buffer.export(os.path.join(getcwd(), 'record.wav'), format='wav')
    status_indicator.write("Stopped & Saved.")
    print("######################## hi #################")
